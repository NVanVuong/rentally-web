...
export const roomDetail: IRoomDetail = {
    ...
    roomblock: {
        ...
        country: "VN",
        coordinate: {
            latitude: 16.074015969147993,
            longitude: 108.14983845126368
        },
    ...
    ratingDetail: {
        ratings: [
            ...
            {
                id: 2,
                createdAt: "2023-11-06T12:30:45.000Z",
                comment:
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque aliquet ante eget erat rhoncus, vel elementum lacus eleifend.",
                cleanRate: 4,
                locationRate: 4,
                securityRate: 3,
                supportRate: 2,
                avgRate: "3.2500",
                renterName: "Polar bear",
                renterPhoto: "https://i.pravatar.cc/150?img=2"
            },
            {
                id: 3,
                createdAt: "2023-11-07T15:10:20.000Z",
                comment:
                    "Duis eu tortor vitae risus lobortis lacinia. Sed vitae purus ut elit varius tincidunt. Integer posuere sapien vitae gravida malesuada.",
                cleanRate: 5,
                locationRate: 5,
                securityRate: 4,
                supportRate: 3,
                avgRate: "4.2500",
                renterName: "Grizzly bear",
                renterPhoto: "https://i.pravatar.cc/150?img=3"
            },
            {
                id: 4,
                createdAt: "2023-11-08T18:45:15.000Z",
                comment:
                    "Vivamus ullamcorper interdum gravida. Donec maximus nisl in urna consequat, nec cursus felis gravida. Suspendisse id tincidunt quam.",
                cleanRate: 2,
                locationRate: 3,
                securityRate: 2,
                supportRate: 1,
                avgRate: "2.0000",
                renterName: "Sun bear",
                renterPhoto: "https://i.pravatar.cc/150?img=4"
            },
            {
                id: 5,
                createdAt: "2023-11-09T22:20:30.000Z",
                comment:
                    "Maecenas suscipit vestibulum ligula, sit amet facilisis metus imperdiet vel. Nunc nec tincidunt lacus. Integer ut metus vel est pulvinar ultrices.",
                cleanRate: 4,
                locationRate: 4,
                securityRate: 3,
                supportRate: 2,
                avgRate: "3.2500",
                renterName: "Brown bear",
                renterPhoto: "https://i.pravatar.cc/150?img=5"
            },
            {
                id: 6,
                createdAt: "2023-11-10T08:05:40.000Z",
                comment:
                    "Fusce facilisis venenatis odio, nec finibus enim gravida eu. Proin rhoncus felis sit amet arcu pellentesque varius.",
                cleanRate: 5,
                locationRate: 5,
                securityRate: 4,
                supportRate: 3,
                avgRate: "4.2500",
                renterName: "Black bear",
                renterPhoto: "https://i.pravatar.cc/150?img=6"
            }
        ],
        avgRate: 2.3,
        avgClean: 3.3,
