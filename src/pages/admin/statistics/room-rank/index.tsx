...
const RoomRank = () => {
    ...
    const expandedArray = Array.from({ length: 5 }, (_, index) => currentRoom[index % currentRoom.length])
        ...
        <div className="w-80">
            ...
            <div className="mt-2 w-full rounded-md px-4 pb-2 shadow-md">
                ...
                <Spin spinning={isLoading}>
                    {expandedArray?.map((room) => (
                        <div key={room.id} className="mb-4 flex items-center justify-between gap-2">
                            <div className="flex aspect-square h-9 w-auto items-center justify-center rounded-md bg-gray-100">
                                <HomeOutlined />
                            </div>
                            <div className="flex flex-col items-start gap-1">
                                <p className="text-sm font-medium">Room F102</p>
                                <p className="text-xs text-gray-400">122 Nguyen Van Linh</p>
                            </div>
